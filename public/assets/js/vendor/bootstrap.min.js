...
!(function(t, e) {
        ...
        const d = x(r, e.replace(w, '')),
            ...
            (function(t, e, i) {
                return function n(s) {
                    ...
                    for (
                        let { target: r } = s; r && r !== this; r = r.parentNode
                    )
    ...
    function Ot(t) {
        for (
            var e = dt(t), i = Tt(t); i && wt(i) && 'static' === yt(i).position;
    ...
    function St(t) {
        return Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 },
            t
        );
    }
        ...
        var i = e,
            ...
            y = (function(t, e, i) {
                var n =
                    ...
                    (function(t) {
                        var e = Vt(At(t)),
                            i = ['absolute', 'fixed'].indexOf(yt(t).position) >=
                            0 && ft(t) ?
                            Ot(t) :
                            t;
                        return ut(i) ?
    ...
    function le() {
        for (
            var t = arguments.length, e = new Array(t), i = 0; i < t; i++
        )
            e[i] = arguments[i];
    ...
    class Ae extends B {
        ...
        show() {
            ...
            if (!P.trigger(this._element, 'show.bs.dropdown', e)
                .defaultPrevented
            ) {
                if (this._inNavbar)
    ...
    class De extends B {
        ...
        hide(t) {
            if (
                (t && ['A', 'AREA'].includes(t.target.tagName) &&
